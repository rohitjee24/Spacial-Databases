...
ogr2ogr -f MySQL MySQL:rmukherjee,host=localhost,user=rmukherjee,password=Rohitjee24 TM_WORLD_BORDERS-0.3.shp -nln WORLD_BORDERS -update -overwrite -lco engine=MYISAM
